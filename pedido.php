...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<h3>Datos de pago</h3>
			<div class="p-line"><div>MONTO TOTAL:</div>$/&nbsp;<span id="montototal"></span>.000</div>
			<div class="p-line"><div>Banco:</div>Corpavi</div>
			<div class="p-line"><div>N° de Cuenta:</div>191-45678945-XXX</div>
			<div class="p-line"><div>Representante:</div>Encargado de ventas</div>
			<p><b>NOTA:</b> Para confirmar la compra debe realizar el deposito por el monto total, y enviar el comprobante al siguiente correo example@example.com o al número de whatsapp 999 666 333</p>
		</div>
	</div>
